-- Restringe a superfície de escrita das ofertas.
-- O fluxo da aplicação só precisa alterar status/resposta/data;
-- valores, autor e tarefa não devem ser mutáveis por clientes autenticados.
